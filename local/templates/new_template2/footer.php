					...
					<div class="default-block__content">
						<ul class="megapost-teasers megapost-teasers_sidebar">
							<li class="megapost-teasers__item megapost-teasers__item_sidebar teaser">
								<a href="https://u.tmtm.ru/mailru_confa_ML_2" target="_blank" class="teaser__image" onclick="if (typeof ga === 'function') { ga('send', 'event', 'tm_block', 'megapost_promo', 'article_pic'); }" rel="nofollow">
									<img src="https://habrastorage.org/getpro/tmtm/pictures/198/c15/03a/198c1503a2b5facf86b43ca681ef3851.png" class="teaser__image-pic"/>
								</a>
								<a href="https://u.tmtm.ru/mailru_confa_ML_2" target="_blank" class="teaser__body" onclick="if (typeof ga === 'function') { ga('send', 'event', 'tm_block', 'megapost_promo', 'article_title'); }" rel="nofollow">
									<h3 class="teaser__body-title">Конфа по машинному обучению: исследуем способности ИИ</h3>
								</a>
							</li>
							<li class="megapost-teasers__item megapost-teasers__item_sidebar teaser">
								<a href="https://u.tmtm.ru/vtbvacancy" target="_blank" class="teaser__image" onclick="if (typeof ga === 'function') { ga('send', 'event', 'tm_block', 'megapost_promo', 'article_pic'); }" rel="nofollow">
									<img src="https://habrastorage.org/getpro/tmtm/pictures/08d/4e7/839/08d4e7839ecd58f2260aa751ec221a03.png" class="teaser__image-pic"/>
								</a>
								<a href="https://u.tmtm.ru/vtbvacancy" target="_blank" class="teaser__body" onclick="if (typeof ga === 'function') { ga('send', 'event', 'tm_block', 'megapost_promo', 'article_title'); }" rel="nofollow">
									<h3 class="teaser__body-title">Работа со сложными задачами, карьерный рост, и все это в профессиональной команде</h3>
								</a>
							</li>
						</ul>
					</div>
		...
		<div class="popup__head popup__head_lang-settings">
			...
			<button type="button" class="btn btn_small btn_popup-close js-hide_lang_settings">
				<svg class="icon-svg" width="12" height="12">
					<use xlink:href="https://habr.com/images/1553247084/common-svg-sprite.svg#close" />
				</svg>
			</button>
		</div>
