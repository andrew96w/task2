	...
	<div class="tabs__level tabs__level_bottom">
		<ul class="toggle-menu ">
			<li class="toggle-menu__item">
				<a href="<?=$APPLICATION->GetCurPageParam("sort=RANK_NONE", array("sort"), false);?>" class="toggle-menu__item-link toggle-menu__item-link_active" rel="nofollow" title="Все публикации в хронологическом порядке">
					<?=GetMessage("CT_SORT_NONE")?>
				</a>
			</li>
			<li class="toggle-menu__item">
				<a href="<?=$APPLICATION->GetCurPageParam("sort=RANK_THREE", array("sort"), false);?>" class="toggle-menu__item-link " rel="nofollow" title="Все публикации с рейтингом 10 и выше">
					<?=GetMessage("CT_SORT_THREE")?>
				</a>
			</li>
			<li class="toggle-menu__item">
				<a href="<?=$APPLICATION->GetCurPageParam("sort=RANK_FIVE", array("sort"), false);?>" class="toggle-menu__item-link " rel="nofollow" title="Все публикации с рейтингом 25 и выше">
					<?=GetMessage("CT_SORT_FIVE")?>
				</a>
			</li>
			<li class="toggle-menu__item">
				<a href="<?=$APPLICATION->GetCurPageParam("sort=RANK_TEN", array("sort"), false);?>" class="toggle-menu__item-link " rel="nofollow" title="Все публикации с рейтингом 50 и выше">
					<?=GetMessage("CT_SORT_TEN")?>
				</a>
			</li>
			<li class="toggle-menu__item">
				<a href="" class="toggle-menu__item-link " rel="nofollow" title="Все публикации с рейтингом 100 и выше">
					≥100
